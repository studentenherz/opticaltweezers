...
const descriptions = ["50% &nbsp;&nbsp; A=4", `&lambda; = 633 nm &nbsp;&nbsp;  I = 17 mW`, 'Cámara de video', 'Espejo ajustable', 'Espejo ajustable', 'f = 20 cm', 'f = 5cm', 'Imagen a la cámara', 'Filtro','Divisor de haz', '100% &nbsp;&nbsp; A=4', '100% &nbsp;&nbsp; A=1', '25% &nbsp;&nbsp; A=4',  '100% &nbsp;&nbsp; A=1','100% &nbsp;&nbsp; A=4',
...
muestraContainer.addEventListener('mouseleave', function() {
